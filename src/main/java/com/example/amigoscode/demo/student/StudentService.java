...
//        Student uStudent = studentRepository.findById(studentId).orElseThrow(() -> new IllegalStateException("STUDENT WITH ID: " + studentId + " DOES NOT EXISTS"));
//        uStudent.setEmail(student.getEmail());
//        uStudent.setName(student.getName());
//        //studentRepository.save(uStudent);
//    }
